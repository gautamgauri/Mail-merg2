...
export const WandIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9.75 17L3 10.25l2.25-2.25L12 14.75l6.75-6.75L21 10.25l-6.75 6.75M5 21v-5.25"
    />
     <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ClipboardIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-6 w-6"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V7a2 2 0 00-2-2h-2m-4-1v8m0 0l-4-4m4 4l4-4m-6 9v2" />

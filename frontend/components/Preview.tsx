            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              {onSendEmails && (
                <button
                  ...
                  disabled={isSending}
                  className="w-full bg-purple-600 hover:bg-purple-700 disabled:bg-purple-900 text-white font-bold py-2.5 px-4 rounded-md transition duration-300 ease-in-out"
                >
            ...
            <div className="mt-4 space-y-6 max-h-[calc(100vh-25rem)] overflow-y-auto pr-2">
              {mergedEmails.map((email, index) => (
                <div key={email.id} className="bg-gray-900 border border-gray-700 rounded-lg p-4 transition duration-300 hover:border-green-500">
                  ...
                  <div className="whitespace-pre-wrap font-sans text-gray-300 text-sm">
                    {email.body}
                  </div>
                </div>
              ))}
